        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10 text-black">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1.5 bg-white rounded-full text-sm font-bold tracking-wider uppercase text-black mb-6 border border-gray-200">Huntersville, NC Walkway Specialists</span>
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-black">Professional <span className="text-black">Sidewalks</span> in Huntersville, NC.</h1>
              <p className="text-xl text-black mb-10 leading-relaxed text-justify">
                Enhance accessibility and curb appeal with ADA-compliant architectural walkways. We handle all Huntersville Right-of-Way permits and design precision-graded paths that guide guests with elegance and safety.
              </p>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/sidewalks/option 1.jpg" alt="Sidewalk Installation Huntersville NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-16">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                <h2 className="text-5xl font-extrabold text-black mb-10 leading-tight">Precision Walkway Construction in Huntersville</h2>
                <p className="text-xl leading-relaxed text-black mb-10 text-justify">
                  A well-designed sidewalk is the connecting thread of your property, guiding guests and residents safely through your landscape while adding a clean, professional finish to your home or business. In Huntersville's varied terrain, walkway construction requires a deep understanding of slope management, soil stability, and local regulations. At Huntersville Concrete Contractor, we ensure that every path we pour is structurally sound, properly graded for water management, and visually integrated with your property's architecture.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 my-16 text-black text-justify">
                  ...
                  <div className="bg-gray-50 p-8 rounded-[32px] border border-gray-100">
                    ...
                    <p className="text-black leading-relaxed">
                      Huntersville's hilly geography demands expert grading. We use laser-levels to design paths that follow the natural contour of the land while ensuring perfect water runoff.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-black text-white p-8 md:p-16 rounded-[60px] my-20 shadow-2xl relative overflow-hidden text-justify">
                  ...
                  <h4 className="text-4xl font-bold mb-8 italic relative z-10 text-justify">The Huntersville Walkway Standard</h4>
                  <div className="space-y-10 relative z-10 text-justify">
                    ...
                    <div className="flex items-start gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">Our established relationship with the Huntersville building department allows for rapid approval of right-of-way projects.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="my-20 grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="text-center p-8 bg-gray-50 rounded-3xl">
                    ...
                    <p className="text-sm text-gray-600 text-justify">Expert construction on Huntersville's challenging slopes and hills.</p>
                  </div>
                </div>

                <h3 className="text-3xl font-bold text-black mb-6 mt-16 text-justify">Why Choose Huntersville Concrete Contractor?</h3>
                <p className="text-lg leading-relaxed text-black mb-12 text-justify">
                  We are Huntersville's trusted partner for high-quality public and private walkways. From the historicTrade Street Trade Street manor paths to modern neighborhood developments in Farragut, we have built miles of safe, beautiful sidewalks across Huntersville County. Our commitment to ADA standards, proper geotechnical preparation, and professional permitting means your project is handled with total expertise from start to finish. Let's design a path that guides you home.
                </p>
              </div>
            </div>
                ...
                <div className="mt-12 space-y-8 p-8 bg-gray-50 rounded-[40px] border border-gray-100 text-black text-justify">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>City Standards:</strong> We follow the specific 4,000 PSI and 4-inch thickness requirements set by the City of Huntersville for all public paths.</p>
                    </div>
                    <div className="flex gap-4">
