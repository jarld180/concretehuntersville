        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10 text-black">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1.5 bg-white rounded-full text-sm font-bold tracking-wider uppercase text-black mb-6 border border-gray-200">Huntersville, NC Pool Surround Experts</span>
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-black">Premium <span className="text-black">Pool Decks</span> in Huntersville, NC.</h1>
              <p className="text-xl text-black mb-10 leading-relaxed text-justify">
                Safety meets style with our slip-resistant, cool-touch concrete pool surrounds. Specifically engineered for the Huntersville climate, our decks combine world-class aesthetics with the durability required for salt-water and chlorinated systems.
              </p>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/pool-decks/option 1.jpg" alt="Pool Deck Installation Huntersville NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="lg:col-span-2 space-y-16">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                ...
                <p className="text-xl leading-relaxed text-black mb-10 text-justify">
                  A pool deck is more than just a surface; it's a critical safety feature and a centerpiece of outdoor entertainment. In the Huntersville area, where summer temperatures often exceed 90 degrees and winter freezes are common, your pool surround needs to be engineered for safety, comfort, and chemical resistance. At Huntersville Concrete Contractor, we specialize in high-performance concrete decks that stand up to the most demanding aquatic environments.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 my-16 text-black text-justify">
                  <div className="bg-gray-50 p-8 rounded-[32px] border border-gray-100">
                    ...
                    <p className="text-black leading-relaxed">
                      We utilize specialized heat-reflective pigments and textures that keep your pool deck up to 20% cooler than standard concrete. This is essential for bare feet during intense July afternoons in Huntersville.
                    </p>
                  </div>
                ...
                <div className="bg-black text-white p-8 md:p-16 rounded-[60px] my-20 shadow-2xl relative overflow-hidden text-justify">
                  ...
                  <h4 className="text-4xl font-bold mb-8 italic relative z-10 text-justify">The Huntersville Pool Side Standard</h4>
