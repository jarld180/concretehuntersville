        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10 text-black">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-black">Foundation Experts in <span className="text-black">Huntersville, NC.</span></h1>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/foundations/option 1.jpg" alt="Foundation Pouring Huntersville NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-16">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                <h2 className="text-5xl font-extrabold text-black mb-10 leading-tight">Elite Foundation Engineering in Huntersville County</h2>
                <p className="text-xl leading-relaxed text-black mb-10 text-justify">
                  Every structure is only as strong as its foundation. In the Huntersville region, where soil composition can vary significantly from dense red clay to sandy loam and karst limestone features, achieving a stable, perfectly level slab requires more than just pouring concrete. It requires a comprehensive geotechnical strategy. At Huntersville Concrete Contractor, we specialize in delivering the most reliable structural concrete solutions in NC.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 my-16 text-black">
                  <div className="bg-gray-50 p-8 rounded-[32px] border border-gray-100">
                    ...
                    <p className="text-black leading-relaxed text-justify">
                      Huntersville is known for its limestone karst features. We utilize specialized foundation designs, including thickened slabs and reinforced footers, to mitigate the risks associated with potential sinkholes and underground voids.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-8 rounded-[32px] border border-gray-100">
                ...
                <div className="bg-black text-white p-8 md:p-16 rounded-[60px] my-20 shadow-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-4xl font-bold mb-8 italic relative z-10 text-justify">Huntersville Foundation Benchmarks</h4>
                ...
                <div className="mt-12 space-y-8 p-8 bg-gray-50 rounded-[40px] border border-gray-100">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Karst Zones:</strong> We understand the limestone geology of Huntersville and design footers that bridge potential voids.</p>
                    </div>
                    <div className="flex gap-4">
                    ...
                    <div className="flex gap-4 text-justify">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Huntersville Codes:</strong> Our team manages all building permits and structural certifications for your peace of mind.</p>
                    </div>
                  </div>
                </div>
              </div>
