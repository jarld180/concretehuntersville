        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10 text-black">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1.5 bg-white rounded-full text-sm font-bold tracking-wider uppercase text-black mb-6 border border-gray-200">Huntersville, NC Patio Artisans</span>
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-black">Designer <span className="text-black">Stamped Patios</span> in Huntersville.</h1>
              <p className="text-xl text-black mb-10 leading-relaxed text-justify">
                A patio should be an extension of your indoor living space—a seamless transition from the comfort of your home to the beauty of the Huntersville landscape. At Huntersville Concrete Contractor, we treat every patio as a work of art, combining structural permanence with world-class decorative finishes.
              </p>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/patios/option 1.jpg" alt="Stamped Concrete Patio Huntersville NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="lg:col-span-2 space-y-16">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                ...
                <p className="text-xl leading-relaxed text-black mb-10 text-justify">
                  Building a stamped concrete patio in Huntersville requires a delicate balance of artistic vision and technical mastery. The local soil, often high in heavy clay, requires a robust structural base, while the intense NC sun and humidity demand high-performance decorative products. At Huntersville Concrete Contractor, we specialize in creating custom outdoor living environments that mimic natural stone, slate, and exotic hardwoods while providing the durability and low maintenance of reinforced concrete.
                </p>
                ...
                <div className="mt-12 space-y-8 p-8 bg-gray-50 rounded-[40px] border border-gray-100 text-black">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Local Style:</strong> Our "Appalachian Valley Slate" pattern is our most popular choice, perfectly complementing Huntersville's natural mountain aesthetics.</p>
                    </div>
                    <div className="flex gap-4">
