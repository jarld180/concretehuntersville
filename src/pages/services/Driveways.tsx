        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1.5 bg-white rounded-full text-sm font-bold tracking-wider uppercase text-black mb-6 border border-gray-200">Huntersville, NC Driveway Specialists</span>
              ...
              <p className="text-xl text-black mb-10 leading-relaxed text-justify">
                Your driveway is the first impression your property makes. At Huntersville Concrete Contractor, we don't just pour concrete; we build reinforced, architecturally significant entryways designed to handle heavy loads, extreme NC weather, and the test of time.
              </p>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/driveways/option 1.webp" alt="Custom Concrete Driveway Huntersville NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                ...
                <p className="text-lg leading-relaxed text-black mb-8 text-justify">
                  A driveway should complement your home's architecture. We offer several signature finishes that are popular in Huntersville's premier neighborhoods:
                </p>
                <ul className="space-y-6 my-12">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-black">Essential for Huntersville's hilly terrain. Our specialized brooming technique provides maximum traction for vehicles during wet or icy NC conditions while maintaining a beautiful, uniform texture.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <Star className="w-6 h-6 text-black shrink-0 mt-1" />
                ...
                <p className="text-lg leading-relaxed text-black mb-12 text-justify">
                  We are a locally owned and operated team that understands Huntersville's building codes and neighborhood standards better than anyone. We handle the entire permitting process with the City of Huntersville and Huntersville County, including all 811 utility locates and mandatory inspections. Our crews are uniformed, professional, and we maintain a clean job site from day one to final walkthrough. When you choose us, you are choosing a partner dedicated to adding permanent value to your home.
                </p>
              </div>
            </div>
                ...
                <div className="mt-12 space-y-8 p-8 bg-gray-50 rounded-[40px] border border-gray-100">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Huntersville Clay:</strong> We excavate deeper than our competitors to ensure the expansive red clay doesn't buckle your new driveway.</p>
                    </div>
                    <div className="flex gap-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Huntersville Permits:</strong> We handle all city and county documentation to ensure your project is 100% compliant.</p>
                    </div>
                  </div>
                </div>
              </div>
