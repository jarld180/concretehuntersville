        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start text-black">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1.5 bg-white rounded-full text-sm font-bold tracking-wider uppercase text-black mb-6 border border-gray-200">Huntersville, NC Flooring Specialists</span>
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-8 text-black">Professional <span className="text-black">Garage Floors</span> in Huntersville, NC.</h1>
              <p className="text-xl text-black mb-10 leading-relaxed text-justify">
                Your garage is one of the most demanding environments in your home. From heavy vehicle loads to chemical spills and thermal cycling, the concrete floor needs to be engineered for survival. At Huntersville Concrete Contractor, we specialize in high-strength structural garage slabs and premium industrial coatings.
              </p>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/garage-floors/option 1.jpg" alt="Garage Floor Coating Huntersville NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="lg:col-span-2 space-y-16">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                ...
                <p className="text-xl leading-relaxed text-black mb-10 text-justify">
                  A garage floor in Huntersville faces a specific set of challenges. The high humidity of the East NC summers can cause "sweating slab syndrome," where moisture from the air condenses on the cool concrete surface. Additionally, the region's winter freeze-thaw cycles can wreak havoc on non-reinforced slabs. At Huntersville Concrete Contractor, we offer a comprehensive suite of solutions ranging from structural slab replacement to industrial-grade Polyaspartic coatings.
                </p>
                ...
                <p className="text-lg leading-relaxed text-black mb-8 text-justify">
                  For many Huntersville homeowners, the existing garage floor is cracked beyond repair or settling due to poor initial compaction. We provide complete removal and replacement services. Our process involves excavating down to stable soil, installing a 6-inch compacted stone base, and pouring a 4,000 PSI high-strength concrete slab reinforced with #3 rebar on 12-inch centers. This creates a floor that can handle the heaviest full-size SUVs and workshop equipment without cracking or shifting.
                </p>
                ...
                <div className="bg-black text-white p-8 md:p-16 rounded-[60px] my-20 shadow-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-4xl font-bold mb-8 italic relative z-10 text-justify">The Huntersville Performance Standard</h4>
                ...
                <div className="mt-12 space-y-8 p-8 bg-gray-50 rounded-[40px] border border-gray-100 text-black">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Humidity Control:</strong> We test the moisture content of every slab before application to ensure permanent adhesion in Huntersville's damp climate.</p>
                    </div>
                    <div className="flex gap-4">
