...
const Home2: React.FC<HomeProps> = ({ cityName = "Huntersville" }) => {
  const isHuntersville = cityName === "Huntersville";
          ...
          <div className="grid md:grid-cols-12 gap-8">
            <div className="md:col-span-7 space-y-8" data-aos="fade-right">
              ...
              <div className="flex justify-between items-start pt-20">
                ...
                <Link to={isHuntersville ? "/foundations" : `/${cityName.toLowerCase().replace(' ', '-')}/foundations`} className="text-[10px] font-black uppercase tracking-widest border-b border-blue-600 pb-1 hover:text-black hover:border-gray-400 transition-all">Details</Link>
              </div>
            </div>
            <div className="md:col-span-5 space-y-8 pt-20" data-aos="fade-left">
              ...
              <div className="flex justify-between items-start pt-20">
                ...
                <Link to={isHuntersville ? "/patios" : `/${cityName.toLowerCase().replace(' ', '-')}/patios`} className="text-[10px] font-black uppercase tracking-widest border-b border-blue-600 pb-1 hover:text-black hover:border-gray-400 transition-all">Details</Link>
              </div>
            </div>
          </div>
        </div>
