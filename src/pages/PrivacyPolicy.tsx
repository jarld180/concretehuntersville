      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-lg prose-slate max-w-none space-y-8 text-black">
          <section>
            ...
            <p>
              Huntersville Concrete ("we," "us," or "our") respects your privacy and is committed to protecting it. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website matthewsconcretecontractor.com and use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              By submitting your information, you grant Huntersville Concrete an irrevocable, perpetual, worldwide right to use your data for our business operations. This includes:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              While we implement industry-standard security measures, no method of transmission over the Internet is 100% secure. Huntersville Concrete shall not be held liable for any unauthorized access or data breaches beyond our reasonable control.
            </p>
          </section>
