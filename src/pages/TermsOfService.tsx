      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-lg prose-slate max-w-none space-y-8 text-black">
          ...
          <section>
            ...
            <p>
              The Site and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by Huntersville Concrete and are protected by United States and international copyright, trademark, and other intellectual property or proprietary rights laws.
            </p>
          ...
          <section>
            ...
            <p className="bg-black text-white p-6 rounded-2xl font-bold border-l-4 border-red-500">
              LIQUIDATED DAMAGES: Any violation of this Section 3 or theft of proprietary content will result in immediate legal action and a minimum liquidated damages fine of $100,000 USD per occurrence, plus all legal fees and costs incurred by Huntersville Concrete.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The Site is provided on an "as-is" and "as-available" basis without any warranties of any kind. Huntersville Concrete does not warrant that the Site will be error-free or uninterrupted.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              In no event shall Huntersville Concrete, its owners, or affiliates be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on the Site.
            </p>
