        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-black mb-10 leading-relaxed">
              From high-performance structural foundations to artisan decorative finishes, Huntersville Concrete provides the technical expertise and local experience required for excellence in Eastern North Carolina.
            </p>
          </div>
        </div>
      </header>
      ...
      <section className="py-24 bg-black overflow-hidden relative">
        <div className="max-w-[1600px] mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Contact Huntersville's leading concrete team for a detailed consultation and professional estimate.
          </p>
